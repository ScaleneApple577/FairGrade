        ...
        <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-8">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <Input
                  ...
                  className="bg-white/5 border-white/10 text-white h-9 w-48"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-xs text-slate-500 mb-1">University / School</p>
                <Input
                  value={university}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-xs text-slate-500 mb-1">Major / Field of Study</p>
                <Input
                  value={major}
