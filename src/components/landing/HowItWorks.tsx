    ...
    <section id="how-it-works" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="hidden md:block absolute top-24 left-1/6 right-1/6 h-0.5 bg-gradient-to-r from-primary via-primary to-green-500 opacity-20" />
          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full border border-slate-200 hover:border-primary/30">
                {/* Number badge */}
                <div className="absolute -top-4 left-8">
                  <span className="inline-block bg-primary text-white font-bold text-sm px-4 py-1 rounded-full">
                    Step {step.number}
                  </span>
                </div>
