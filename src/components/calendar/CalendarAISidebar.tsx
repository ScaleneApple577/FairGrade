...
export function CalendarAISidebar({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={wb ? "bg-white/60 border border-gray-200 rounded-xl p-5" : "bg-white/[0.04] border border-white/10 rounded-2xl p-6"}>
      ...
      {/* Upcoming Meetings */}
      <div className={wb ? "bg-white/60 border border-gray-200 rounded-xl p-5" : "bg-white/[0.04] border border-white/10 rounded-2xl p-5"}>
